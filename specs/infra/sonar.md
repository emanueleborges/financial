...
Setup único no SonarCloud: importar o repo GitHub; `sonar.projectKey` deve coincidir com a chave do projeto (padrão `emanueleborges_financial-hub`, organização `emanueleborges`).
